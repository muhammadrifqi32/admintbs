...
class User extends CI_Controller {
	...
	public function testingtk()
	{
		$this->load->view('testingtanpakotak');
	}
	public function testingdk()
	{
		$this->load->view('testingdengankotak');
	}
			...
			$this->load->library('image_lib');
    			...
    			$this->image_lib->resize();
						...
						for ($i=160; $i < 318; $i+=10) { 
  	      				...
  	      				$datas['g']=$g/$rata;
  	      				$datas['b']=$b/$rata;
			$this->load->view('testingtanpakotak', $datas);
		}
