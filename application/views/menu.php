        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url();?>Welcome/index/" aria-expanded="false">
                        <i class="mdi mdi-view-dashboard"></i>
                        <span class="hide-menu">Dashboard</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url();?>tutorial" aria-expanded="false">
                        <i class="mdi mdi-flashlight"></i>
                        <span class="hide-menu">Tutorial</span>
                    </a>
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url();?>profil/view" aria-expanded="false">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow waves-effect waves-dark sidebar-link" aria-expanded="false">
                        ...
                        <span class="hide-menu">Upload Data Training</span>
                    </a>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link has-arrow waves-effect waves-dark sidebar-link" aria-expanded="false">
                        ...
                        <span class="hide-menu">Table Data Training</span>
                    </a>
                    <ul class="collapse first-level">                               
                        <li class="sidebar-item">
