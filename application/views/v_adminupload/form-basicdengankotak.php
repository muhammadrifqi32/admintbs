        ...
        <div class="page-breadcrumb">
            <div class="row">
                <div class="col-5 align-self-center">
                    <h4 class="page-title">Upload Data Training Dengan Kotak</h4>
                </div>
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Upload Data Training Dengan Kotak</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card card-body">
                        ...
                        <div class="form-group">
                            ...
                            <?php echo form_open_multipart('upload2/aksi_upload');?>
