            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="<?php echo base_url();?>assets2/assets/images/users/5.jpg" class="rounded-circle" width="150" />
                                    <?php 
                                    foreach($username as $u)
                                    { 
                                    ?>
                                    <?php } ?>
                                    <h4 class="card-title m-t-10"><?php echo $u->nama?></h4>
                                    
                                    <h6 class="card-subtitle"><?php echo $u->username?></h6>
                                    <!--
                                    <div class="row text-center justify-content-md-center">
                                        <div class="col-4"><a href="<?php echo base_url();?>assets2/javascript:void(0)" class="link"><i class="icon-people"></i> <font class="font-medium">254</font></a></div>
                                        <div class="col-4"><a href="<?php echo base_url();?>assets2/javascript:void(0)" class="link"><i class="icon-picture"></i> <font class="font-medium">54</font></a></div>
                                    </div>
                                    -->                                    
                                </center>
                            </div>
